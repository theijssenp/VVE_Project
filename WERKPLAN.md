...
| F03 | Drizzle-opzet, migratierunner, Testcontainers-harnas, eerste migratie (`vve`, `persoon`) | M | F02 | §6.1, §6.3 | **bezig** |
...
| ID | Blok | Omvang | Na | Spec | Status |
|---|---|---|---|---|---|
| V01 | VvE aanmaken en beheren door applicatiebeheerder; beheerderaccount; instellink én "opnieuw wachtwoord versturen" | M | F08, F10 | M1, §3.3 · AC1.1–1.5 | todo |
| V02 | Wooneenheden: CRUD, typen, m², breukdelen, stemmen, controle op de som van de breukdelen | M | V01 | M2 · AC2.1–2.3 | todo |
...
| V04 | Uitnodigingen: token, verlopen, opnieuw versturen, registratie- en activatieflow, bestaande persoon koppelen | M | V01 | §3.3 · AC2.2 | todo |
...
| ID | Blok | Omvang | Na | Spec | Status |
|---|---|---|---|---|---|
| G01 | Standaard grootboekschema als seed, rekeningbeheer per VvE | S | V01 | §5.7 · AC9.1 | todo |
| G02 | Boekjaar, boekingsservice, deferred constraint trigger, append-only rechten | M | G01 | §6.7, §7.4 · tests 20–21 | todo |
